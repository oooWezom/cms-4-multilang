...
<div class="widget box">
    ...
    <div class="widgetContent" id="sValuesList">
        <table class="table table-striped table-bordered table-hover checkbox-wrap" data-specification="<?php echo Route::param('id'); ?>">
            <thead>
                <tr>
                    <th class="align-center">
                        <?php $first = true;
...
<div id="sParametersSimple" data-id="<?php echo Route::param('id'); ?>"></div>
    ...
    $(function(){
        ...
        if( $('#sParametersSimple').length ) {
            ...
            $('#sSave').on('click', function(e){
                ...
                $.ajax({
                    url: '/wezom/ajax/specifications/addSimpleSpecificationValue',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
            ...
            $('#sValuesList').on('click', '.sSave', function(e){
                ...
                $.ajax({
                    url: '/wezom/ajax/specifications/editSimpleSpecificationValue',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        specification_id: sID,
