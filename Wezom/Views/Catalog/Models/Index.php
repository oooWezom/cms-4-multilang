        ...
        <div class="widget">
            <div class="widgetHeader" style="padding-bottom: 10px;">
                <?php echo \Forms\Form::open(['class' => 'widgetContent filterForm', 'action' => '/wezom/'.Core\Route::controller().'/index']); ?>
                    ...
                    <div class="col-md-2">
                        <?php echo \Forms\Builder::select(\Core\Support::selectData($brands, 'alias', 'name', ['', __('Все')]),
                            Core\Arr::get($_GET, 'brand_alias'), [
                            'name' => 'brand_alias',
                            ], __('Бренд')); ?>
                    </div>
                    <div class="col-md-2">
                        ...
                        <tbody>
                            <?php foreach ( $result as $obj ): ?>
                                <tr data-id="<?php echo $obj->id; ?>">
                                    ...
                                    <td><a href="/wezom/brands/edit/<?php echo $brands_aliases[$obj->brand_alias]['id']; ?>" target="_blank"><?php echo $brands_aliases[$obj->brand_alias]['name']; ?></a></td>
                                        ...
                                        <ul class="table-controls">
                                            <li>
                                                ...
                                                <ul class="dropdownMenu pull-right">
                                                    ...
                                                    <li>
                                                        <a href="/wezom/brands/edit/<?php echo $brands_aliases[$obj->brand_alias]['id']; ?>" title="<?php echo __('Перейти к бренду'); ?>"><i class="fa fa-inbox"></i> <?php echo __('Перейти к бренду'); ?></a>
                                                    </li>
                                                    <li class="divider"></li>
                                                    <li>
