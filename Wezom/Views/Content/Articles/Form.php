                        ...
                        <div class="contentImage">
                            <?php if (is_file( HOST . Core\HTML::media('images/articles/original/'.$obj->image, false) )): ?>
                                <div class="contentImageView">
                                    <a href="<?php echo Core\HTML::media('images/articles/original/'.$obj->image); ?>" class="mfpImage">
                                        <img src="<?php echo Core\HTML::media('images/articles/small/'.$obj->image); ?>" />
                                    </a>
                                </div>
                                <div class="contentImageControl">
                                    ...
                                    <br>                                   
                                    <a class="btn btn-warning" href="<?php echo \Core\General::crop('articles', 'small', $obj->image); ?>">
