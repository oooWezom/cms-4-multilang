<?php
    ...
    class Callback extends \Wezom\Modules\Base {
        ...
        function before() {
            parent::before();
            $this->_seo['h1'] = __('Сообщения из формы заказа звонка');
            $this->_seo['title'] = __('Сообщения из формы заказа звонка');
            $this->setBreadcrumbs(__('Сообщения из формы заказа звонка'), 'wezom/'.Route::controller().'/index');
